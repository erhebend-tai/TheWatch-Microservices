...
public record SubmitFootageRequest(Guid CameraId, Guid SubmitterId, double GpsLatitude, double GpsLongitude, DateTime StartTime, DateTime EndTime, string MediaUrl, string? Description = null, List<string>? Tags = null);
