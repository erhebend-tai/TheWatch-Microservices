...
public partial class ReposDetailPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await getBranchProtectionService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//repos/{owner}/{repo}/branches/{branch}/protection/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//repos/{owner}/{repo}/branches/{branch}/protection");
            }
            catch (Exception ex)
            {
