...
namespace INFRASTRUCTURE.Web.Pages;

public partial class GatewayListPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // items = await getMyRateLimitsService.GetAllAsync();
    ...
    private void OnView(object item)
    {
        ...
        Navigation.NavigateTo($"//gateway/rate-limits/me/{item.GetType().GetProperty("Id")?.GetValue(item)}");
    }

    private void OnEdit(object item)
    {
        // TODO: Navigate to edit page
        Navigation.NavigateTo($"//gateway/rate-limits/me/{item.GetType().GetProperty("Id")?.GetValue(item)}/edit");
    }
