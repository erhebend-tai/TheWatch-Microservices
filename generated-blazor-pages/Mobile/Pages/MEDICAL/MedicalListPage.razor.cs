...
namespace MEDICAL.Web.Pages;

public partial class MedicalListPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // items = await searchMedicationInventoryService.GetAllAsync();
    ...
    private void OnView(object item)
    {
        ...
        Navigation.NavigateTo($"//medical/pharmacy/inventory/{item.GetType().GetProperty("Id")?.GetValue(item)}");
    }

    private void OnEdit(object item)
    {
        // TODO: Navigate to edit page
        Navigation.NavigateTo($"//medical/pharmacy/inventory/{item.GetType().GetProperty("Id")?.GetValue(item)}/edit");
    }
