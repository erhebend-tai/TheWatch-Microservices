...
public partial class MedicalListPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // items = await getVitalAlertConfigService.GetAllAsync();
    ...
    private void OnView(object item)
    {
        ...
        Navigation.NavigateTo($"//medical/vitals/alerts/config/{item.GetType().GetProperty("Id")?.GetValue(item)}");
    }

    private void OnEdit(object item)
    {
        // TODO: Navigate to edit page
        Navigation.NavigateTo($"//medical/vitals/alerts/config/{item.GetType().GetProperty("Id")?.GetValue(item)}/edit");
    }
