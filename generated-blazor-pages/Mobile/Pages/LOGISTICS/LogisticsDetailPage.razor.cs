...
public partial class LogisticsDetailPage
{
    [Parameter]
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await getIntersectionStatusService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//logistics/traffic/intersections/{intersectionid}/status/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//logistics/traffic/intersections/{intersectionid}/status");
            }
            catch (Exception ex)
            {
