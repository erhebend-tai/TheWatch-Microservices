...
public partial class CacheDetailPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await getCachedInferenceResultService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//cache/inference/{cachekey}/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//cache/inference/{cachekey}");
            }
            catch (Exception ex)
            {
