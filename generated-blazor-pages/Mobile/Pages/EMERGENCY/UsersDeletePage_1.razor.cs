...
public partial class UsersDeletePage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await deleteTriggerService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//users/me/triggers/{triggerid}/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//users/me/triggers/{triggerid}");
            }
            catch (Exception ex)
            {
