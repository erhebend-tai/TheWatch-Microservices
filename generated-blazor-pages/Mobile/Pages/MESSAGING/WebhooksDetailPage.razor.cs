...
public partial class WebhooksDetailPage
{
    [Parameter]
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await getWebhookDeliveryService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//webhooks/{webhookid}/deliveries/{deliveryid}/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//webhooks/{webhookid}/deliveries/{deliveryid}");
            }
            catch (Exception ex)
            {
