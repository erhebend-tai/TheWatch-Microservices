...
public partial class SignupDetailPage
{
    [Parameter]
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await getWalkthroughStepService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//signup/{registrationid}/walkthrough/step/{stepid}/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//signup/{registrationid}/walkthrough/step/{stepid}");
            }
            catch (Exception ex)
            {
