...
public partial class GeofencesDeletePage
{
    [Parameter]
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await deleteGeofenceService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//geofences/{geofenceid}/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//geofences/{geofenceid}");
            }
            catch (Exception ex)
            {
