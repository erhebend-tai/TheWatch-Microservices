...
public partial class PlacesListPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // items = await searchPlacesService.GetAllAsync();
    ...
    private void OnView(object item)
    {
        ...
        Navigation.NavigateTo($"//places/{item.GetType().GetProperty("Id")?.GetValue(item)}");
    }

    private void OnEdit(object item)
    {
        // TODO: Navigate to edit page
        Navigation.NavigateTo($"//places/{item.GetType().GetProperty("Id")?.GetValue(item)}/edit");
    }
