...
public partial class SubscriptionsDeletePage
{
    [Parameter]
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await unsubscribeFromIncidentService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//subscriptions/incidents/{incidentid}/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//subscriptions/incidents/{incidentid}");
            }
            catch (Exception ex)
            {
