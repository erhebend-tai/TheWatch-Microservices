...
public partial class LegalDetailPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await getSubpoenaComplianceService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//legal/subpoenas/{subpoenaid}/compliance/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//legal/subpoenas/{subpoenaid}/compliance");
            }
            catch (Exception ex)
            {
