...
namespace LEGAL.Web.Pages;

public partial class LegalDetailPage
{
    [Parameter]
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await downloadDiscoveryPackageService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//legal/discovery/packages/{requestid}/download/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//legal/discovery/packages/{requestid}/download");
            }
            catch (Exception ex)
            {
