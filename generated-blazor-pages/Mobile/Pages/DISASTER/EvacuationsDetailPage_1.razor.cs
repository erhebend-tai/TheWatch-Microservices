...
public partial class EvacuationsDetailPage
{
    [Parameter]
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await listEvacuationMessagesService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//evacuations/{evacuationid}/messages/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//evacuations/{evacuationid}/messages");
            }
            catch (Exception ex)
            {
