...
public partial class DeviceStorageDeletePage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await deleteKeychainEntryService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//device-storage/keychain/{entryid}/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//device-storage/keychain/{entryid}");
            }
            catch (Exception ex)
            {
