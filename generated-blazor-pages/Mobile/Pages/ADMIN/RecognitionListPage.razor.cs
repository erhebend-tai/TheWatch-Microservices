...
public partial class RecognitionListPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // items = await listRecognitionAlertsService.GetAllAsync();
    ...
    private void OnView(object item)
    {
        ...
        Navigation.NavigateTo($"//recognition/alerts/{item.GetType().GetProperty("Id")?.GetValue(item)}");
    }

    private void OnEdit(object item)
    {
        // TODO: Navigate to edit page
        Navigation.NavigateTo($"//recognition/alerts/{item.GetType().GetProperty("Id")?.GetValue(item)}/edit");
    }
