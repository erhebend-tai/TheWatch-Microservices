...
public partial class AdminDetailPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await getIncidentCostSummaryService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//admin/cost-recovery/incidents/{incidentid}/summary/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//admin/cost-recovery/incidents/{incidentid}/summary");
            }
            catch (Exception ex)
            {
