...
public partial class RecognitionDetailPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await realtimeObjectDetectionService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//recognition/sessions/{sessionid}/ws/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//recognition/sessions/{sessionid}/ws");
            }
            catch (Exception ex)
            {
