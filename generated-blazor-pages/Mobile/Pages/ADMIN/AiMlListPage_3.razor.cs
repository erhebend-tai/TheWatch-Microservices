...
public partial class AiMlListPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // items = await getStaffingRecommendationsService.GetAllAsync();
    ...
    private void OnView(object item)
    {
        ...
        Navigation.NavigateTo($"//ai-ml/forecasting/recommendations/{item.GetType().GetProperty("Id")?.GetValue(item)}");
    }

    private void OnEdit(object item)
    {
        // TODO: Navigate to edit page
        Navigation.NavigateTo($"//ai-ml/forecasting/recommendations/{item.GetType().GetProperty("Id")?.GetValue(item)}/edit");
    }
