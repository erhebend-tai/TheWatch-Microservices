...
public partial class AiMlListPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // items = await getPredictedVolumeService.GetAllAsync();
    ...
    private void OnView(object item)
    {
        ...
        Navigation.NavigateTo($"//ai-ml/forecasting/volume/{item.GetType().GetProperty("Id")?.GetValue(item)}");
    }

    private void OnEdit(object item)
    {
        // TODO: Navigate to edit page
        Navigation.NavigateTo($"//ai-ml/forecasting/volume/{item.GetType().GetProperty("Id")?.GetValue(item)}/edit");
    }
