...
public partial class IncidentsDetailPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await getRetentionService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//incidents/{incidentid}/evidence/{evidenceid}/retention/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//incidents/{incidentid}/evidence/{evidenceid}/retention");
            }
            catch (Exception ex)
            {
