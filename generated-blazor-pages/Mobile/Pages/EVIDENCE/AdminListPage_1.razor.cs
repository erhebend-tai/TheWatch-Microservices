...
public partial class AdminListPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // items = await getSummonerPatternsService.GetAllAsync();
    ...
    private void OnView(object item)
    {
        ...
        Navigation.NavigateTo($"//admin/analytics/summoner-patterns/{item.GetType().GetProperty("Id")?.GetValue(item)}");
    }

    private void OnEdit(object item)
    {
        // TODO: Navigate to edit page
        Navigation.NavigateTo($"//admin/analytics/summoner-patterns/{item.GetType().GetProperty("Id")?.GetValue(item)}/edit");
    }
