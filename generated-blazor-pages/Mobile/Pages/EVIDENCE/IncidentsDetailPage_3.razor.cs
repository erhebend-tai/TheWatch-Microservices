...
public partial class IncidentsDetailPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await getAccessLogService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//incidents/{incidentid}/evidence/{evidenceid}/access-log/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//incidents/{incidentid}/evidence/{evidenceid}/access-log");
            }
            catch (Exception ex)
            {
