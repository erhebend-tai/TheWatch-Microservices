...
namespace EVIDENCE.Web.Pages;

public partial class SummonerListPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // items = await getSummonerFeedbackService.GetAllAsync();
    ...
    private void OnView(object item)
    {
        ...
        Navigation.NavigateTo($"//summoner/feedback-history/{item.GetType().GetProperty("Id")?.GetValue(item)}");
    }

    private void OnEdit(object item)
    {
        // TODO: Navigate to edit page
        Navigation.NavigateTo($"//summoner/feedback-history/{item.GetType().GetProperty("Id")?.GetValue(item)}/edit");
    }
