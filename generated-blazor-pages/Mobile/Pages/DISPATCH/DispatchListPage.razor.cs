...
namespace DISPATCH.Web.Pages;

public partial class DispatchListPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // items = await listCADSystemsService.GetAllAsync();
    ...
    private void OnView(object item)
    {
        ...
        Navigation.NavigateTo($"//dispatch/cad-systems/{item.GetType().GetProperty("Id")?.GetValue(item)}");
    }

    private void OnEdit(object item)
    {
        // TODO: Navigate to edit page
        Navigation.NavigateTo($"//dispatch/cad-systems/{item.GetType().GetProperty("Id")?.GetValue(item)}/edit");
    }
