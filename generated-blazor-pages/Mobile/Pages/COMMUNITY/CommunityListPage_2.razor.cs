...
public partial class CommunityListPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // items = await listAssistingResourcesService.GetAllAsync();
    ...
    private void OnView(object item)
    {
        ...
        Navigation.NavigateTo($"//community/mutual-aid/resources/{item.GetType().GetProperty("Id")?.GetValue(item)}");
    }

    private void OnEdit(object item)
    {
        // TODO: Navigate to edit page
        Navigation.NavigateTo($"//community/mutual-aid/resources/{item.GetType().GetProperty("Id")?.GetValue(item)}/edit");
    }
