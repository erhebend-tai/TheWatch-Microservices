...
public partial class ProjectsDeletePage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await deleteTableService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//projects/{projectid}/datasets/{datasetid}/tables/{tableid}/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//projects/{projectid}/datasets/{datasetid}/tables/{tableid}");
            }
            catch (Exception ex)
            {
