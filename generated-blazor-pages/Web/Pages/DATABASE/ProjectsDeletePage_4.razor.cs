...
public partial class ProjectsDeletePage
{
    [Parameter]
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await deleteDocumentService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//projects/{projectid}/databases/{databaseid}/documents/{documentpath}/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//projects/{projectid}/databases/{databaseid}/documents/{documentpath}");
            }
            catch (Exception ex)
            {
