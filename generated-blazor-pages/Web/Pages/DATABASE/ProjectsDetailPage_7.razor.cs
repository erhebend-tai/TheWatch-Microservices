...
public partial class ProjectsDetailPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await listRoutinesService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//projects/{projectid}/datasets/{datasetid}/routines/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//projects/{projectid}/datasets/{datasetid}/routines");
            }
            catch (Exception ex)
            {
