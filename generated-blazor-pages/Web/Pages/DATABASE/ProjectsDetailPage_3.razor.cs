...
public partial class ProjectsDetailPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await listTablesService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//projects/{projectid}/datasets/{datasetid}/tables/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//projects/{projectid}/datasets/{datasetid}/tables");
            }
            catch (Exception ex)
            {
