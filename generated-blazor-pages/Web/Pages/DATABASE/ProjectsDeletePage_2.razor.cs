...
public partial class ProjectsDeletePage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await deleteRoutineService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//projects/{projectid}/datasets/{datasetid}/routines/{routineid}/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//projects/{projectid}/datasets/{datasetid}/routines/{routineid}");
            }
            catch (Exception ex)
            {
