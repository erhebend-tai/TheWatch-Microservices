...
public partial class UsersDetailPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await getUserTriggerPhrasesService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//users/{userid}/trigger-phrases/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//users/{userid}/trigger-phrases");
            }
            catch (Exception ex)
            {
