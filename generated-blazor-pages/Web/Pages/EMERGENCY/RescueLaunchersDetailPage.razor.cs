...
public partial class RescueLaunchersDetailPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await listLauncherEventsService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//rescue-launchers/{launcherid}/events/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//rescue-launchers/{launcherid}/events");
            }
            catch (Exception ex)
            {
