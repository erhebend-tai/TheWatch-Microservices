...
public partial class RescueLaunchersDetailPage
{
    [Parameter]
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await getLauncherInventoryService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//rescue-launchers/{launcherid}/inventory/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//rescue-launchers/{launcherid}/inventory");
            }
            catch (Exception ex)
            {
