...
public partial class AdminListPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // items = await getResponderPatternsService.GetAllAsync();
    ...
    private void OnView(object item)
    {
        ...
        Navigation.NavigateTo($"//admin/analytics/responder-patterns/{item.GetType().GetProperty("Id")?.GetValue(item)}");
    }

    private void OnEdit(object item)
    {
        // TODO: Navigate to edit page
        Navigation.NavigateTo($"//admin/analytics/responder-patterns/{item.GetType().GetProperty("Id")?.GetValue(item)}/edit");
    }
