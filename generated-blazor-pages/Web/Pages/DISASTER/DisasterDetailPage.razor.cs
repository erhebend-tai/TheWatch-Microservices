...
public partial class DisasterDetailPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await getDamageAnalysisResultsService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//disaster/damage-assessment/results/{taskid}/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//disaster/damage-assessment/results/{taskid}");
            }
            catch (Exception ex)
            {
