...
public partial class DisclosuresListPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // items = await getResponderLiabilityDisclosureService.GetAllAsync();
    ...
    private void OnView(object item)
    {
        ...
        Navigation.NavigateTo($"//disclosures/responder-liability/{item.GetType().GetProperty("Id")?.GetValue(item)}");
    }

    private void OnEdit(object item)
    {
        // TODO: Navigate to edit page
        Navigation.NavigateTo($"//disclosures/responder-liability/{item.GetType().GetProperty("Id")?.GetValue(item)}/edit");
    }
