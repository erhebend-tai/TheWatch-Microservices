...
public partial class DirectionsListPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // items = await listRoadClosuresService.GetAllAsync();
    ...
    private void OnView(object item)
    {
        ...
        Navigation.NavigateTo($"//directions/traffic/road-closures/{item.GetType().GetProperty("Id")?.GetValue(item)}");
    }

    private void OnEdit(object item)
    {
        // TODO: Navigate to edit page
        Navigation.NavigateTo($"//directions/traffic/road-closures/{item.GetType().GetProperty("Id")?.GetValue(item)}/edit");
    }
