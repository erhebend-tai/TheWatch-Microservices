...
public partial class MedicalDetailPage
{
    [Parameter]
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await getIncidentTriageSummaryService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//medical/triage/incidents/{incidentid}/summary/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//medical/triage/incidents/{incidentid}/summary");
            }
            catch (Exception ex)
            {
