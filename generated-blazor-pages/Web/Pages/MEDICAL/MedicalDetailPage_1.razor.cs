...
public partial class MedicalDetailPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await getEmergencyMedicalRecordService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//medical/records/{userid}/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//medical/records/{userid}");
            }
            catch (Exception ex)
            {
