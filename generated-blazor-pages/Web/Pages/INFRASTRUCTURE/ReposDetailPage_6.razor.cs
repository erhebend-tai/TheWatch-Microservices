...
public partial class ReposDetailPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await compareCommitsService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//repos/{owner}/{repo}/compare/{base}...{head}/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//repos/{owner}/{repo}/compare/{base}...{head}");
            }
            catch (Exception ex)
            {
