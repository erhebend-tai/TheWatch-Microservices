...
public partial class ReposDeletePage
{
    [Parameter]
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await deleteRepoWebhookService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//repos/{owner}/{repo}/webhooks/{webhook_id}/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//repos/{owner}/{repo}/webhooks/{webhook_id}");
            }
            catch (Exception ex)
            {
