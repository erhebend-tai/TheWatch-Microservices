...
public partial class LogisticsListPage
{
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // items = await getNearbyAVStatusService.GetAllAsync();
    ...
    private void OnView(object item)
    {
        ...
        Navigation.NavigateTo($"//logistics/av/fleet/status/{item.GetType().GetProperty("Id")?.GetValue(item)}");
    }

    private void OnEdit(object item)
    {
        // TODO: Navigate to edit page
        Navigation.NavigateTo($"//logistics/av/fleet/status/{item.GetType().GetProperty("Id")?.GetValue(item)}/edit");
    }
