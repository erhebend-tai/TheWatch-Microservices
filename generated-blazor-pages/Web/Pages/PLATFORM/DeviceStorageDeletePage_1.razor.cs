...
public partial class DeviceStorageDeletePage
{
    [Parameter]
    ...
    private async Task LoadDataAsync()
    {
        ...
        try
        {
            ...
            // item = await deleteVaultItemService.GetByIdAsync(Id);
    ...
    private void OnEdit()
    {
        Navigation.NavigateTo($"//device-storage/vaults/{vaultid}/items/{itemid}/{Id}/edit");
    }
    ...
    private async Task OnDelete()
    {
        ...
        if (confirmed == true)
        {
            try
            {
                ...
                Navigation.NavigateTo("//device-storage/vaults/{vaultid}/items/{itemid}");
            }
            catch (Exception ex)
            {
