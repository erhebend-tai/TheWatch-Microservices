...
locals {
  ...
  container_services = {
    "p1-coregateway"    = { cpu = "2", memory = "1Gi",   min_instances = 2, max_instances = 5,   image_tag = "latest", env_vars = {}, public = false }
    "p2-voiceemergency" = { cpu = "4", memory = "2Gi",   min_instances = 3, max_instances = 20,  image_tag = "latest", env_vars = {}, public = false }
    "p3-meshnetwork"    = { cpu = "2", memory = "1Gi",   min_instances = 2, max_instances = 10,  image_tag = "latest", env_vars = {}, public = false }
    "p4-wearable"       = { cpu = "2", memory = "1Gi",   min_instances = 2, max_instances = 5,   image_tag = "latest", env_vars = {}, public = false }
    "p5-authsecurity"   = { cpu = "4", memory = "2Gi",   min_instances = 2, max_instances = 10,  image_tag = "latest", env_vars = {}, public = false }
    "p6-firstresponder" = { cpu = "4", memory = "2Gi",   min_instances = 3, max_instances = 15,  image_tag = "latest", env_vars = {}, public = false }
    "p7-familyhealth"   = { cpu = "2", memory = "1Gi",   min_instances = 2, max_instances = 10,  image_tag = "latest", env_vars = {}, public = false }
    "p8-disasterrelief" = { cpu = "2", memory = "1Gi",   min_instances = 2, max_instances = 10,  image_tag = "latest", env_vars = {}, public = false }
    "p9-doctorservices" = { cpu = "2", memory = "1Gi",   min_instances = 2, max_instances = 5,   image_tag = "latest", env_vars = {}, public = false }
    "p10-gamification"  = { cpu = "1", memory = "512Mi", min_instances = 1, max_instances = 3,   image_tag = "latest", env_vars = {}, public = false }
    "p11-surveillance"  = { cpu = "4", memory = "2Gi",   min_instances = 2, max_instances = 10,  image_tag = "latest", env_vars = {}, public = false }
    "p12-notifications" = { cpu = "0.5", memory = "512Mi", min_instances = 0, max_instances = 3,  image_tag = "latest", env_vars = {}, public = false }
    "geospatial"        = { cpu = "4", memory = "2Gi",   min_instances = 2, max_instances = 10,  image_tag = "latest", env_vars = {}, public = false }
    "dashboard"         = { cpu = "2", memory = "1Gi",   min_instances = 2, max_instances = 5,   image_tag = "latest", env_vars = {}, public = true }
  }
}
